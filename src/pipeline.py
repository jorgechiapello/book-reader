...
class Pipeline:
    ...
    def run_stage_1(self, text: str, output_path: Path) -> Path:
        """Stage 1: Convert raw text into an annotated ChapterScript JSON."""
        return self.writer.write(text, output_path)
    ...
    def run_pipeline(self, text: str, output_dir: Path, chapter_filename: str, ctx: "SynthesisContext") -> Path:
        ...
        self.run_stage_1(text, script_path)
